...
public class CMBehaviorlistActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_add:
                Intent intent = new Intent(CMBehaviorlistActivity.this,BehaviorAddCoffeeActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Behaviorlist=CMBehaviorlistActivity.this;
    ...
    private class GetData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(CMBehaviorlistActivity.this,
    ...
    private void showResult(){
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                MyItem m_i = new MyItem(pname,days,power,time,type,Switch);
    ...
    class MyItem{
        MyItem(String aPname,int aDays,int aPower,String aTime,String aType,int aSwitch){
            pName=aPname;
            Days=aDays;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            View.OnClickListener mOnClickListener =new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(CMBehaviorlistActivity.this, PopupActivity.class);
                    intent.putExtra("Behavior_pname", arSrc.get(pos).pName);
                    intent.putExtra("Behavior_dname","CM");
                    intent.putExtra("Behavior_type", arSrc.get(pos).Type);
