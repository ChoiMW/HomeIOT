...
public class BehaviorAddTVActivity extends AppCompatActivity {
    ...
    private String behavior_new_days_add="";
    ...
    public void mOnClickMdfComplete(View v){
        ...
        if(checkBox.isChecked()){
            behavior_new_days_add+="Mon";
        }
        checkBox=(CheckBox)findViewById(R.id.checkBox_Tuesday);
        if(checkBox.isChecked()){
            if(behavior_new_days_add!=""){
                behavior_new_days_add+=",";
            }
            behavior_new_days_add+="Tues";
        }
        ...
        if(checkBox.isChecked()){
            ...
            behavior_new_days_add+="Sun";
        }
        if(behavior_new_days_add.equals("")){
            Toast.makeText(this, "Please Select Days", Toast.LENGTH_SHORT).show();
        }
        else if(behavior_new_days_add.equals("")){
    ...
    class mThread extends Thread {
        ...
        public void run(){
            try {
                ...
                postData += "&" + URLEncoder.encode("newDays", "UTF-8") + "=" + URLEncoder.encode(behavior_new_days_add, "UTF-8");
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (result.equals("Add Success")) {
                            ...
                            endActivity.finish();
                            // 다시 실행한다.
                            Intent intent = new Intent(BehaviorAddTVActivity.this,BehaviorlistActivity.class);
